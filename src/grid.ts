...
const buildWalls = () => {
	...
	// L1
	setSymmetricWall(0, 2, 'vertical', 'xy', 'L1');
	setSymmetricWall(1, 2, 'vertical', 'xy', 'L1');
	// L2
	...
	// L3
	setSymmetricWall(3, 3, 'vertical', 'x', 'L3');
	setSymmetricWall(2, 3, 'vertical', 'x', 'L3');
	// L4
	setSymmetricWall(4, 5, 'vertical', 'x', 'L4');
	// L5
